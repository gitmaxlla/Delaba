...
Зайдите в интерфейс пользователя и введите первоначальный логин и пароль, выводимый системой в консоль для создания главного администратора системы; далее вам будет предложено изменить их на новые.
