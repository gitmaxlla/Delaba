...
export async function clientLoader({ params }: { params: SubjectParams }) {
        ...
        >
          ...
          >
            ...
            <h2
              style={{
                ...
                color: subjectColors.get(name!),
              }}
            >
              Всего работ: {tasks.length}
            </h2>
          </div>
          <div className={styles.tasks}>
            <div
              ...
              className={styles["card-subject-compact"]}
              style={{
            ...
            {Object.entries(tasks).map(([num, task]) => (
              <TaskCard
                ...
                toFocusId={focusId}
                task={task}
                num={tasks.length - parseInt(num)}
              /> // TODO: why's num string?
            ))}
          </div>
        </div>
      </div>
