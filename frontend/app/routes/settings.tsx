...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Настройки / Delaba" },
    { name: "description", content: "Пользовательские настройки Delaba." },
  ];
}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                {moderator ? (
                  ...
                  >
                    ...
                    >
                      Включить визуальное редактирование
                    </p>
                    <Switch
                      checked={enableEdit}
                      onChange={(value) => {
              ...
              <h1 style={{ lineHeight: "60px", textAlign: "end" }}>
                {usingSection}
              </h1>
            </div>
          </div>
