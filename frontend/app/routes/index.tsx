...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Лендинг и страница авторизации в приложение Delaba.",
    },
  ];
}
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener("keydown", authenticateOnEnter);
    };
  }, []);
        ...
        >
          <div style={{ display: "flex", flexDirection: "row", gap: "20px" }}>
            {initMode ? (
              <img
                alt="'Go back' arrow"
                style={{ width: "60px", transform: "rotate(-90deg)" }}
                onClick={() => {
                  setErrorMsg("");
                  setInitMode(false);
                }}
            ...
            <h1 className={styles.h1} style={{ color: colors.primary }}>
              Делаба ☺
            </h1>
          </div>
          <div
          ...
          >
            ...
            {initMode ? (
              <>
                ...
                />
                <input
                  onChange={newPasswordCheckChanged}
          ...
          >
            ...
            <img
              fetchPriority="high"
              alt="Delaba app logo with an arrow in a circular outline."
              className={styles["logo-main"]}
              src="./logo.svg"
            />
            <img
              fetchPriority="high"
              alt="Delaba app logo win an arrow in a filled circle"
