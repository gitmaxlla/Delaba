...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Графическая панель управления данными сервиса Delaba.",
    },
  ];
}
            ...
            <Flex vertical align="stretch" gap="middle">
                    ...
                    .then((response) => {
                      if (response.status === 200) {
                        openNotification(
                          ...
                          "Данные для входа пользователя отправлены на указанный почтовый адрес.",
                        );
                      }
                    });
                }}
              ...
              <Table
                ...
                onChange={(pagination, filters, sorter) => {
                  setFilter({
                    ...filter,
                    newestFirst: sorter.order == "ascend",
                  });
