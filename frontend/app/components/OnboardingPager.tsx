      ...
      >
        ...
        >
          <Centerer>
            <h3
              className={styles.h2}
              style={{ padding: "20px", textWrap: "wrap" }}
            >
              {pages[page]}
            </h3>
          </Centerer>
      ...
      <div style={{ paddingRight: "50px", display: "flex", gap: "20px" }}>
        <div
          ...
          style={{
            ...
            width: "15px",
            height: "15px",
            background: page != 0 ? `${colors.primary + "55"}` : colors.primary,
          }}
        />
        <div
          aria-label="Page 2"
          ...
          style={{
            ...
            width: "15px",
            height: "15px",
            background: page != 1 ? `${colors.primary + "55"}` : colors.primary,
          }}
        />
        <div
          aria-label="Page 3"
          ...
          style={{
            ...
            width: "15px",
            height: "15px",
            background: page != 2 ? `${colors.primary + "55"}` : colors.primary,
          }}
        />
      </div>
    </div>
